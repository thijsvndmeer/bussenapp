    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-3">
        ...
        {!isFeatureGraphic && !isNoDevice && (
          <div className="space-y-1.5">
            <Label className="text-xs">
              {(slide.layout === "two-devices" || slide.layout === "three-devices") ? "Front device screenshot" : "Screenshot"}
            </Label>
            <ScreenshotPicker
              label="Primary"
        ...
        {slide.layout === "three-devices" && (
          <div className="space-y-1.5">
            <Label className="text-xs">Third device screenshot</Label>
            <ScreenshotPicker
              label="Tertiary"
...
function ElementTransformControls({
  ...
  if (slide.layout === "two-devices" || slide.layout === "three-devices") present.push("deviceSecondary");
